cordova.define("jp.wizcorp.phonegap.plugin.wizViewManagerPlugin.wizViewManagerPlugin", function(require, exports, module) {/* WizViewManager for cordova - Handle Views create/remove/show/hide etc.
*
 * @author Ally Ogilvie  
