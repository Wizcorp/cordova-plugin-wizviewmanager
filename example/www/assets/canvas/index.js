...
// ctx.font         = '68pt KulminoituvaRegular';


                                                                                 
                                                                                 
var kitty = new Image();
kitty.src = '/assets/img/891blog_keyboard_cat.jpg';
...
kitty.onload = function() {
    ...
    ctx.drawImage(this,0,0,150,150);
     ...
     ctx.fillText  ('Keyboard Cat', 0, 120);
};

kitty.onError = function() {
	console.log("failed image");
}


console.log("my context -> " + JSON.stringify(ctx));
...
var wizMessageReceiver = function(data) {
    ...
    var viewName = window.encodeURIComponent( "mainView" );
    var message = window.encodeURIComponent( JSON.stringify( { message: "Thanks for the message!" } ) );
    console.log(message);
    
                                                   
                                                   
    wizViewManager.message( viewName, message );
}
